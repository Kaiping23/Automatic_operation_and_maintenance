...
function git_pull_admin(){
   ...
   git clone -b $branch ssh://git@g.km365.pw:122/frontend/sass-admin.git
...
function git_pull_wechat(){
   ...
   git clone -b $branch ssh://git@g.km365.pw:122/frontend/wechatWeb.git
   cd wechatWeb
   #yarn 
   git pull
   $yarn_command
...
function git_pull_saaswechat(){
   ...
   git clone -b $branch ssh://git@g.km365.pw:122/frontend/saas-weichat.git && cd saas-weichat
...
function git_pull_wmypc(){
   ...
   git clone -b $branch ssh://git@g.km365.pw:122/frontend/wmypcWeb.git
   cd wmypcWeb
   #yarn 
   git pull
   $yarn_command
